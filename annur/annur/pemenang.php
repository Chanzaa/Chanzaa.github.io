<?php
 ...
 <div id="mainbody">
     <div id="tajuk"><p>
       PEMENANG PERTANDINGAN SUARA AZAN KATEGORI MENENGAH ATAS SEMUHSIN<br> 
     </div>
  
 <?php

echo "Tarikh Hari Ini: ". $tarikh_semasa = Date('d-m-Y');  
$tarikh_keputusan = date('20-05-2022'); 
 
############ Tambahan kod untuk perbandingan masa ################# 
 
$pm_trkh_semasa = strtotime($tarikh_semasa); 
$pm_trkh_kptsn = strtotime($tarikh_keputusan); 
 
#################################################################### 
 
if ($pm_trkh_semasa < $pm_trkh_kptsn) 
{ 
  echo "<center> >>> Pemenang akan diumumkan pada  
        $tarikh_keputusan <<<"; 
} 
else 
{ 
